...
![VPC Diagram](full-VPC-diagram-15.png)
...
![Go to VPC](fing-vpc-service-go-there-1.png)
...
![Create NAT Gateway](create-NAT-10.png)

### Step 9: Create Route Tables

Create route tables for public and private subnets.

![Create Route Table](create-route-table-11.png)
...
![Edit Route Table](edit-route-table-11.png)

![Create Public Route Table](create-public-RT-12.png)

### Step 11: Verify Route Tables

Verify that your route tables are configured correctly.

![Check Created Route Tables](check-created-RT-13.png)
...
![Connect Subnets to Route Tables](connect-subnets-to-according-RT-14.png)
...
![Create Security Group for Public EC2](create-sec-group-for-pub-ec2.png)
...
![Create Security Group for Private EC2](create-priv-sec-group-ec2.png)
...
![Create Public EC2 Instance](create-ec2-sutup-public-inctance-1.png)

![EC2 Setup Public](create-ec2-sutup-pub-2.png)

![EC2 Setup Network](create-ec2-setup-network-3.png)
...
![Connect to Private VM via Public](conect-to-priv-vm-via-public.png)
...
![Internet Access from Private Subnet](result-of-access-to-internet-from-priv.png)
